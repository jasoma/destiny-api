...
const uriTemplate = _.template('${membershipType}/Account/${destinyMembershipId}/Character/${characterId}/ItemReference/${itemHash}/');
...
class ItemReferenceDetailRequest {
...
module.exports = ItemReferenceDetailRequest;
