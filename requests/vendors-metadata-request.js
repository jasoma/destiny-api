...
const uriTemplate = _.template('${membershipType}/MyAccount/Character/${characterId}/Vendor/${vendorHash}/Metadata/');
...
module.exports = VendorsMetadataRequest;
