...
const uriTemplate = _.template('${membershipType}/Account/${destinyMembershipId}/Character/${characterId}/');
...
module.exports = CharacterSummaryRequest;
