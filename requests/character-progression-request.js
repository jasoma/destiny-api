...
const uriTemplate = _.template('${membershipType}/Account/${destinyMembershipId}/Character/${characterId}/Progression/');
...
class CharacterProgressionRequest {
...
module.exports = CharacterProgressionRequest;
