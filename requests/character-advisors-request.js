...
const uriTemplate = _.template('${membershipType}/Account/${destinyMembershipId}/Character/${characterId}/Advisors/V2/');
...
class CharacterAdvisorsRequest {
...
module.exports = CharacterAdvisorsRequest;
