...
const uriTemplate = _.template('Stats/UniqueWeapons/${membershipType}/${destinyMembershipId}/${characterId}/');
...
module.exports = WeaponHistoryRequest;
